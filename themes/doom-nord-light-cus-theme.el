...
;;
(defgroup doom-nord-light-cus-theme nil
  "Options for the `doom-nord-light-cus' theme."
  :group 'doom-themes)

(defcustom doom-nord-light-cus-brighter-modeline nil
  "If non-nil, more vivid colors will be used to style the mode-line."
  :group 'doom-nord-light-cus-theme
  :type 'boolean)

(defcustom doom-nord-light-cus-brighter-comments nil
  "If non-nil, comments will be highlighted in more vivid colors."
  :group 'doom-nord-light-cus-theme
  :type 'boolean)

(defcustom doom-nord-light-cus-comment-bg doom-nord-light-cus-brighter-comments
  "If non-nil, comments will have a subtle, darker background. Enhancing their
legibility."
  :group 'doom-nord-light-cus-theme
  :type 'boolean)

(defcustom doom-nord-light-cus-padded-modeline doom-themes-padded-modeline
  "If non-nil, adds a 4px padding to the mode-line. Can be an integer to
determine the exact padding."
  :group 'doom-nord-light-cus-theme
  :type '(choice integer boolean))

(defcustom doom-nord-light-cus-region-highlight t
...
;;
(def-doom-theme doom-nord-light-cus
  ...
  ((bg         '("#E5E9F0" nil       nil))
   ...
   (builtin teal)
   (comments (if doom-nord-light-cus-brighter-comments dark-cyan (doom-darken base5 0.2)))
   (doc-comments (doom-darken (if doom-nord-light-cus-brighter-comments dark-cyan base5) 0.25))
   (constants magenta)
   (functions teal)
   (keywords blue)
   (methods teal)
   ...
   (variables violet)
   (numbers magenta)
   (region (pcase doom-nord-light-cus-region-highlight
   ...
   (-modeline-bright doom-nord-light-cus-brighter-modeline)
   (-modeline-pad
    (when doom-nord-light-cus-padded-modeline
      (if (integerp doom-nord-light-cus-padded-modeline) doom-nord-light-cus-padded-modeline 4)))
  ...
  (((font-lock-comment-face &override)
   ...
   ((region &override)
    :foreground (if (memq doom-nord-light-cus-region-highlight '(frost snowstorm))
                    bg-alt))
...
;;; doom-nord-light-cus-theme.el ends here
